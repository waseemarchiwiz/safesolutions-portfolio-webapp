        ...
        <section className="max-w-[77rem] mx-auto relative text-white">
          ...
          <div className="my-10 relative px-5 md:px-3 mx-auto max-w-7xl pt-10 pb-16 md:pt-16">
            ...
            <AnimatedGroup preset="blur-slide">
              <div className="group flex w-fit items-center gap-4 rounded-full border border-white/10 bg-zinc-900 p-1 pl-4 shadow-lg shadow-black/30 hover:bg-zinc-800 transition-colors">
