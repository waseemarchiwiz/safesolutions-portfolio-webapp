...
import { Software } from "@/pages/Client/softwaredetails/Software";
import { Link } from "react-router-dom";

// const ServiceCard = ({ icon: Icon, id, title, description, features }) => (
...
//     {/* Use the correct service id for the Link */}
//     <Link
//       to={`/software/${id}`}
  ...
  <div className="min-h-screen bg-[#FFFFFF] dark:bg-black py-16 px-4">
    <div className="container mx-auto">
      ...
      <div className="text-center mt-12">
        <CustomButton label="Get Started" to={"/contact"} />
      </div>
    </div>
  </div>
);
