      ...
      <div className="bg-white ">
        <div className="max-w-6xl mt-10   mx-auto p-20">
          <div className="text-center">
            <h2 className="text-3xl font-extrabold text-gray-800 inline-block relative after:absolute after:w-4/6 after:h-1 after:left-0 after:right-0 after:-bottom-4 after:mx-auto  after:rounded-lg-full">
              LATEST BLOGS
            </h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-16 max-lg:max-w-3xl max-md:max-w-md mx-auto">
            <div className="bg-white cursor-pointer rounded-lg overflow-hidden shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] relative group">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT-kkcAq-0sL1bC7JDz0tHeW1YF8nHOrFvE6xJ4xwqz8uJPxHGu6-ZTvLzg-N1iPQwXuec&usqp=CAU"
                alt="Blog Post 1"
            ...
            <div className="bg-white cursor-pointer rounded-lg overflow-hidden shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] relative group">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQfy716tBTYbT7Bv5_shAB8W6Qu7m6FpJMCrLtB3cJnhNhnt6yqShdri1tXfV5rUcVODNE&usqp=CAU"
                alt="Blog Post 3"
                className="w-full h-96 object-cover"
              />
              <div className="p-6 absolute bottom-0 left-0 right-0 bg-black opacity-90">
