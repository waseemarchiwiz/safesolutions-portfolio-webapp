        ...
        <div className="grid grid-cols-12 gap-6 items-center">
          ...
          <div className="col-span-12 md:col-span-8">
            <p className="text-gray-600 leading-relaxed dark:text-white">
              ...
              success. We have been delivering innovative solutions that help companies
              navigate the complexities of the digital age. With a skilled team of experts,
              we design and implement tailored IT infrastructures that empower our clients
