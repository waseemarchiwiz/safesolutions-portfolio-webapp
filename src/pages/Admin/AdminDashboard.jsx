  ...
  return (
    <div className="   p-10 ">
      ...
      <div className=" p-5  mt-3 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 gap-5 sm:gap-5 md:gap-2 lg:gap-8 xl:gap-10">
        <KPICard
          title="Blogs"
          value={kpiData?.getTotalBlogCount?.totalBlogs}
          change="5.2%"
        />
        <KPICard
          title="Careers"
          value={kpiData?.getTotalCareerCount?.totalCareer}
          change="5.2%"
        />
        <KPICard
          title="Testimonials"
          value={
            kpiData.getTotalTestimonialCount.length > 0
              ? kpiData?.getTotalTestimonialCount?.totalTestimonial
              : "3"
          }
          change="5.2%"
        />
