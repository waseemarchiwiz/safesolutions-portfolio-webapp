  ...
  const jobOpenings = [
    {
      ...
      type: "Full-time",
      description:
        "We are looking for a talented software engineer to join our team and build innovative solutions.",
    },
    {
      ...
      type: "Full-time",
      description:
        "Create user-centric design experiences that delight our customers and drive product innovation.",
    },
    {
      ...
      type: "Full-time",
      description:
        "Drive our brand strategy and create compelling marketing campaigns across multiple channels.",
    },
    {
      ...
      type: "Full-time",
      description:
        "Provide exceptional customer support and help our users have the best possible experience.",
    },
  ];
