...
const Contactus = () => {
  return (
    <div className="dark:bg-gray-800 dark:text-gray-200">
      <div className=" dark:bg-gray-800 dark:text-gray-200 flex flex-col items-center justify-center px-6   gap-20">
        <div
      ...
      <div className="w-full   flex flex-row   justify-center items-center py-10 gap-10 ">
